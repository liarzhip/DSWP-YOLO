...
model = torch.hub.load("ultralytics/yolov5", "custom", path="path/to/best0.7880.pt")  # local model
model = torch.hub.load("path/to/yolov5", "custom", path="path/to/best0.7880.pt", source="local")  # local repo
```
